...
#ifndef CASPER_CEF3_BROWSER_BROWSER_WINDOW_H
...
namespace casper
{
    ...
    namespace cef3
    {
        ...
        namespace browser
        {
            ...
            // indicated.
            class BrowserWindow : public casper::cef3::client::common::ClientHandlerDelegate
            {
            public:
            ...
            protected:
                ...
                CefRefPtr<casper::cef3::client::common::ClientHandler> client_handler_;
                bool is_closing_;
...
#endif  // CASPER_CEF3_BROWSER_BROWSER_WINDOW_H
