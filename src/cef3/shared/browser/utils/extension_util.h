...
#ifndef CASPER_CEF3_SHARED_BROWSER_UTILS_EXTENSION_UTIL_H_
#define CASPER_CEF3_SHARED_BROWSER_UTILS_EXTENSION_UTIL_H_
#pragma once
...
#endif // CASPER_CEF3_SHARED_BROWSER_UTILS_EXTENSION_UTIL_H_
